...
- (IBAction)buyNow:(id)sender {
    ...
    payRequest.merchantIdentifier = @"merchant.com.huihuishenghuo.huihuiPay";  //申请的merchantID
...
//    PKAddressFieldNone *PKaddress=[PKAddressFieldNone ];
    ...
    PKPaymentSummaryItem *total = [PKPaymentSummaryItem summaryItemWithLabel:@"EDC" amount:totalAmount];  //最后这个是支付给谁。哈哈，快支付给我
